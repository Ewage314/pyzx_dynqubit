...
class TestPhasePoly(unittest.TestCase):
    ...
    def assertCircuitEquivalent(self, c1, c2):
        ...
        return # TODO make this code work with new pytket version
        tk_circuit1 = pyzx_to_tk(c1)
        tk_circuit2 = pyzx_to_tk(c2)
        try:
            aer_state_b = AerStateBackend()
            aer_state_b.compile_circuit(tk_circuit1)
            aer_state_b.compile_circuit(tk_circuit2)
    ...
    """ This test is covered with the Steiner-mode
    ...
    # Permutation finding is not used anymore
    ...
    """ tket-steiner no longer works with new pytket version
